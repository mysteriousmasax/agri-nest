AGRI-NEST v7.0 User Ecosystem

This module defines the AGRI-NEST v7.0 stakeholder taxonomy. The platform is structured around four functional groups and 24 distinct user roles, ensuring representation across field operations, service delivery, commercial value chains, and platform administration.

1. PRIMARY AGRICULTURAL USERS

1.1 Smallholder Farmer
- Description: Individual farming 1–5 acres, mixed crops and/or livestock
- Key interactions: Digital Farm, Jicho AI, Soko marketplace, Usafiri transport, Mshauri advisory, Benki ya Shambani finance, Taka kwa Mali assets, community groups
...
- Key interactions: Multi-farm dashboard, manager/worker role management, bulk transactions, ERP-lite workflows, compliance monitoring
...
- Key interactions: Animal registry, health tracking, breeding management, production logs for milk/eggs, veterinary bookings
...
- Key interactions: Group dashboard, collective buying and selling, shared equipment calendar, group loans, group chat
...
- Key interactions: Mshauri profile, consultation booking (video/visit), rating system, subscription management
...
- Key interactions: Animal health consultations, vaccination scheduling, disease reporting, TALIRO certification compliance
...
- Key interactions: Usafiri job alerts, bidding, GPS tracking, rating system, escrow payments
...
- Key interactions: Soko product search, bulk orders, escrow payments, supplier ratings
...
- Key interactions: Benki ya Shambani portal, farmer data consent, loan origination, repayment tracking, portfolio monitoring
...
- Key interactions: Anonymised farmer registry, regional analytics, pest surveillance, subsidy management, tax reporting
...
- Key interactions: User management, financial audit, AI model training, system configuration, backup/restore
...
- Web Dashboard: Commercial farmers, group admins, experts, students, buyers, exporters, lenders, insurers, government, NGOs, investors, all admin roles
- API: Banks, insurance firms, government agencies, exporters, researchers, partner apps
